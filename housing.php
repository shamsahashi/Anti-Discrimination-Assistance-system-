...
<style>
/* ── Page-level form styles (shared across all report forms) ── */
.form-hero {
    background: var(--navy);
...
<div class="form-hero">
    <div class="container">
        <div class="form-hero-eyebrow">🏠 Housing</div>
        <h1>Housing Discrimination Report</h1>
        <p>Report discrimination in renting, buying, lending, or accessing housing services. All submissions are confidential.</p>
    </div>
</div>
        ...
        <div class="form-layout">
            ...
            <form action="submit.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-card">
                    ...
                    <!-- Property / Respondent Info -->
                    <div class="form-section">
                        <div class="form-section-title">
                            <div class="form-section-icon">🏢</div>
                            Property &amp; Respondent Information
                        </div>
                        <div class="form-row">
                            <div class="field">
                                <label>Landlord / Property Owner / Agent Name <span class="required">*</span></label>
                                <input type="text" name="respondent_name" required placeholder="Name of person or company">
                            </div>
                            <div class="field">
                                <label>Respondent Phone or Email</label>
                                <input type="text" name="respondent_contact" placeholder="Optional">
                            </div>
                        </div>
                        <div class="form-row full">
                            <div class="field">
                                <label>Property Address (Where Discrimination Occurred) <span class="required">*</span></label>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            ...
                            <div class="field">
                                <label>Type of Housing Issue <span class="required">*</span></label>
                                <select name="housing_type" id="housing_type" onchange="toggleConditional('housing_type','Other','other_housing_box','other_housing_input')" required>
                                    <option value="">-- Select --</option>
                                    <option>Refusal to Rent or Sell</option>
                                    <option>Discriminatory Terms or Conditions</option>
                                    <option>Mortgage / Lending Discrimination</option>
                                    <option>Harassment or Intimidation</option>
                                    <option>Failure to Provide Reasonable Accommodation</option>
                                    <option>Eviction</option>
                                    <option>Advertising Discrimination</option>
                                    <option>Other</option>
                                </select>
                                <div id="other_housing_box" class="other-box">
                                    <input type="text" name="other_housing_type" id="other_housing_input" placeholder="Please describe...">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="field">
                                ...
                                <select name="resolution" id="resolution" onchange="toggleConditional('resolution','Other','other_resolution_box','other_resolution_input')" required>
                                    ...
                                    <option>Housing Access / Placement</option>
                    ...
                    <div class="form-section">
                        ...
                        <div class="field">
                            ...
                            <textarea name="description" required placeholder="Include dates, locations, names of individuals involved, what was said or done, and any other relevant details..."></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <label class="file-upload-label">
                            ...
                            <span>Leases, emails, photos, letters — max 10MB</span>
            ...
            <aside class="form-sidebar">
                ...
                <div class="sidebar-card">
                    ...
                    <ul>
                        <li>Exact dates and property address</li>
                        <li>What was said or written</li>
                        <li>Names of landlord / agents</li>
                        <li>Any written communications</li>
                        <li>Prior complaints or denials</li>
                    </ul>
                </div>
                <div class="sidebar-card">
                    <h4>⏱ Filing Deadlines</h4>
                    <p>Fair Housing Act complaints must generally be filed within <strong>1 year</strong> of the discriminatory act.</p>
                </div>
                <div class="sidebar-card">
                    <h4>📞 Need Help?</h4>
